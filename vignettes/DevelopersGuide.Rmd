...
**ClassifyR** uses the Roxygen kind of documentation. Please document all parameters and include an example using a data set already in the package to demonstrate what the function does. See any of the existing R files for the structure of the documentation.
