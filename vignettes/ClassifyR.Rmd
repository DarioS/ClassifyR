...
The functions below produce a ranking, of which different size subsets are tried and the classifier performance evaluated, to select a best subset of features.

```{r, echo = FALSE}
htmltools::img(src = knitr::image_uri("providedForSelectionUse.png"), 
               style = 'margin-left: auto;margin-right: auto')
```
