...
Dario Strbenac, Grahan Mann, John Ormerod, Jean Yang  
...
performancePlot(list(DEresults, DVresults, DDresults),
...
ROCplot(list(DVresults, DDresults))
```
...
These are the cost values chosen for the three folds of the first resampling. In the second fold, the best value was 1, whereas for the first and third folds, it was 0.01.
