                   ...
                   margin = grid::unit(c(1, 1, 1, 1), "lines"), rotate90 = FALSE, showLegend = TRUE, plot = TRUE, parallelParams = bpparam())
{
  ...
  allFeaturesList <- lapply(results, function(result)
  {
    ...
    if(is.data.frame(chosenFeatures[[1]])) # Data set and feature ID columns.
    ...
    else if(class(chosenFeatures[[1]]) == "list" && is.data.frame(chosenFeatures[[1]][[1]])) # Data set and feature ID columns.
