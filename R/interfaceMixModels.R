...
#' #' mandatory.
#' #' @param models A \code{\link{MixModelsListsSet}} of models generated by the
...
#' #' second highest sum for a feature to be allowed to vote. Can be a vector of
#' #' cutoffs. If no features for a particular sample have a difference large
#' #' enough, the class predicted is simply the largest class.
...
#' #' data, or lists of such information, if both weighted and unweighted voting
#' #' was used or a range of \code{minDifference} values was provided.
