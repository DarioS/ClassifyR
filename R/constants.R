...
.ClassifyRenvir[["functionsTable"]] <- data.frame(
              ...
              "SVMtrainInterface", "SVMpredictInterface", "coxphTrainInterface", "coxphPredictInterface", "coxphRanking", "coxnetTrainInterface", "coxnetPredictInterface"),
              ...
              "Support Vector Machine", "Cox proportional hazards", "Cox proportional hazards", "Cox proportional hazards", "Penalised cox proportional hazards", "Penalised cox proportional hazards")
              )